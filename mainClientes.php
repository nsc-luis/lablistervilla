<?php
	...
	{
		header("location:http://" . $_SERVER['SERVER_NAME'] . "/clientes.php");
	}
	header('Content-Type: text/html; charset=UTF-8');
	
	// Primero incluimos el archivo de configuración
	include('confClientes.php');
	...
	include('php/includes/encabezadoClientes.php');
	...
	include('php/includes/pieDePaginaClientes.php');
?>