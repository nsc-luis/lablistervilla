<?php
	...
	$logo = $logoEnOrden == "1" ? "/php/lib/blobLogoCte.php?idCliente=" . $idCliente : "/php/lib/blobLogoClinica.php";
	...
	$html = '
		...
		<body>
			...
			<span class="titulo2">FOLIO: ' . $folioDocto . '</span>
			<table>
				<tr>
	...
	$html .= '
		...
		ENTREGA DE RESULTADOS EN HORARIO DE LUNES A VIERNES DE 3:00 pm A 4:00 pm Y LOS SABADOS DE 1:00 PM A 2:00PM
	';
