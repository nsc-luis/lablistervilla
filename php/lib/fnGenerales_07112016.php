<?php
	...
	switch ($proceso) {
		case "login":
			...
			$sql = "SELECT * FROM usuarios WHERE cveUsr LIKE BINARY '$txtUser' AND passUsr LIKE BINARY '$txtPass'";
		...
		case "nuevoCliente":
			...
			$cte->setSerieCte($_POST['serieCte']);
		...
		case "nuevoPaciente":
			...
			if ( $msj != "" ) {
				...
				$url = "http://" . $_SERVER['SERVER_NAME'] . "/main.php?mod=pacientes";
				echo "
					OK! <br />
					<SCRIPT>
						window.location='$url';
