<?php
	$logoClinica = "php/lib/blobLogoClinica.php";
?>
	...
	<div id="encabezado">
		<div id="encabezadoAreaPrincipal">
			<div class="titulo-logo">
				<img class="imgLogo" src="<?php echo $logoClinica; ?>" />
				...
				<ul>
					...
					<li class="menuLv1"><a href="#">Reportes</a>
						<ul class="menuLv2">
							...
							<li><a href="?mod=rptEstPorDia" >Estudios por día</a></li>
							<li><a href="?mod=rptEstPorCliente" >Estudios diarios x cliente</a></li>
						</ul>
					</li>
