						...
						<table width="100%">
							...
							<tr class="trBD" ng-repeat="pacienteEncontrado in resultadoDeBusqueda">
								...
								<td style="text-align: center">
									...
									<button title="Imprimir info paciente"><span class="ui-icon ui-icon-print"></span></button>
								</td>
							</tr>
						</table>
					</div>
				...
				<table width="100%">
					...
					<tr class="trBD" ng-repeat="paciente in pacientes | filter: filtrarPaciente">
						...
						<td style="text-align: center">
							...
							<button class="Imprimir info paciente"><span class="ui-icon ui-icon-print"></span></button>
						</td>
					</tr>
				</table>
