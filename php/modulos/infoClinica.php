	...
	<div id="contenido" ng-app="clinicas" ng-controller="infoClinica">
		...
		<span ng-repeat="clinica in currentClinica">
			...
			<label>Celula: </label>
			<input type="text" ng-model="clinica.cedulaDelResponsable" value="{{clinica.cedulaDelResponsable}}" /> <br />
			<label>Logo de la clinica: </label>
			<input type="file" id="logoClinica"/> <br />
			<label>Firma (resposable): </label>
			<input type="file" id="firmaDelResponsable" /> <br />
			<label>Cedula (imagen): </label>
			<input type="file" id="imgCedulaDelResponsable" /> <br />
			<hr />
