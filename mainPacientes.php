<?php
	...
	{
		header("location:http://" . $_SERVER['SERVER_NAME'] . "/pacientes.php");
	}
	header('Content-Type: text/html; charset=UTF-8');
	
	// Primero incluimos el archivo de configuración
	include('confPacientes.php');
	...
	include('php/includes/encabezadoPacientes.php');
	...
	include('php/includes/pieDePaginaPacientes.php');
?>