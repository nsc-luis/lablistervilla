<?php
			...
			<table>
				<tr>
					...
					<td width="80%">
						...
						<strong>Usuario: </strong>' . $nombreUsr . '
					</td>
				</tr>
			</table>
			</div>
	...
	$listaDeOrdenes = $ods->rptEstudiosPorDia($idUsuario, $fechaInicial);
	$ordenes = array();
	...
	for ($i=0; $i<count($ordenes); $i++) {
		...
		// $bar = mysqli_fetch_assoc($listaExamenes);
		// echo "<pre>";
		// print_r($bar);
		// echo "</pre>";
